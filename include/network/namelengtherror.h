...
namespace Network
{
    ...
    public:
        ...
        explicit NameLengthError(std::string&& t_value) noexcept;
        ...
        auto operator=(const NameLengthError&) noexcept ->
            NameLengthError& = default;
        auto operator=(NameLengthError&&) noexcept ->
            NameLengthError& = default;
    };
}
