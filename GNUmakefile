...
get-sun-path-fd.cpp get-sun-path-fddata.cpp get-sun-path-length.cpp	\
get-sun-pointer.cpp integererror.cpp is-running.cpp is-valid.cpp	\
logicerror.cpp namelengtherror.cpp open-endpoint.cpp open-fd.cpp	\
oserrorresult.cpp parse-argumentspan.cpp parse.cpp			\
pathlengtherror.cpp rangeerror.cpp reset-last-context-error.cpp		\
