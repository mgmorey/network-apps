...
bind-socket.cpp buffer.cpp bytestring.cpp charactererror.cpp		\
cleanup.cpp close.cpp connect-endpoint.cpp connect-socket.cpp		\
...
to-bytestring-sa.cpp to-bytestring-str.cpp to-bytestring-sun.cpp	\
to-path-bytestring.cpp to-path-descriptor.cpp to-string-in-addr.cpp	\
to-string-in6-addr.cpp validate-bs.cpp validate-sa.cpp			\
validate-sin.cpp validate-sin6.cpp validate-sun.cpp version.cpp		\
