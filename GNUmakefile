...
connect-endpoint.cpp create-runtime.hpp create-socket-handle.cpp	\
...
reset-os-error.cpp run.cpp runtimedata.cpp runtimeerror.cpp		\
shutdown.cpp socketdata.cpp socketfamily.cpp socketflags.cpp		\
sockethost.cpp socketlimits.cpp socketprotocol.cpp sockettype.cpp	\
stream-address.cpp stream-addrinfo.cpp stream-runtime.cpp		\
...
set-api-error.cpp set-os-error.cpp socketapi.cpp start.cpp stop.cpp	\
write.cpp
