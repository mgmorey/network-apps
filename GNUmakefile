...
error.cpp fd.cpp format-ai-error.cpp format-os-error.cpp format.cpp	\
...
get-sun-path-length.cpp get-sun-path.cpp get-sun-pointer.cpp		\
...
socketflags.cpp socketprotocol.cpp sockettype.cpp stream-address.cpp	\
