...
get-hostnameresult.cpp get-name.cpp get-nameresult.cpp			\
...
inetsocket.cpp is-running.cpp listen.cpp logicerror.cpp			\
open-endpoint.cpp open-handle.cpp open.cpp oserrorresult.cpp		\
parse-argumentspan.cpp parse.cpp quote.cpp rangeerror.cpp		\
reset-api-error.cpp reset-os-error.cpp run.cpp runtimeerror.cpp		\
shutdown.cpp socketapi.cpp socketdata.cpp socketfamily.cpp		\
socketflags.cpp sockethost.cpp socketlimits.cpp socketprotocol.cpp	\
sockettype.cpp stream-address.cpp stream-addrinfo.cpp			\
stream-failmode.cpp stream-runtime.cpp stream-socket.cpp		\
