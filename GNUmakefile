...
address-sun.cpp address.cpp addresserror.cpp addressstring.cpp		\
addrinfo.cpp argumentdata.cpp bind-endpoint.cpp bind-socket.cpp		\
buffer.cpp bytestring.cpp cleanup.cpp close.cpp connect-endpoint.cpp	\
...
stream-addrinfo.cpp stream-context.cpp stream-template.cpp		\
sunlengtherror.cpp template.cpp to-bytespan-sa.cpp			\
to-bytespan-sun.cpp to-bytespan-void.cpp to-bytestring-ai.cpp		\
...
to-string-address.cpp to-string-bytestring.cpp to-string-sin.cpp	\
to-string-sin6.cpp to-string-version.cpp version.cpp
