...
argumentdata.cpp arguments.cpp bind-endpoint.cpp bind-fd.cpp		\
buffer.cpp bytestring.cpp cleanup-fd.cpp cleanup.cpp close.cpp		\
...
format.cpp get-arguments.cpp get-endpoint.cpp get-endpointresult.cpp	\
get-hostname.cpp get-hostnameresult.cpp get-hosts.cpp			\
...
open-fd.cpp oserrorresult.cpp rangeerror.cpp reset-last-os-error.cpp	\
runtimeerror.cpp set-last-os-error.cpp sizeerror.cpp socket.cpp		\
